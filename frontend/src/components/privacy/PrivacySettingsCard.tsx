...
const styles = StyleSheet.create({
  ...
  title: { ...typography.h3, fontSize: 16, color: colors.primaryDark, marginBottom: spacing.sm },
  body: { ...typography.bodySmall, lineHeight: 20, marginBottom: spacing.md },
  statusRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: spacing.xs },
  statusLabel: { ...typography.caption },
  statusValue: { ...typography.caption, fontWeight: '700' },
  on: { color: colors.success },
  off: { color: colors.textMuted },
  hint: { ...typography.caption, fontStyle: 'italic', marginTop: spacing.sm },
